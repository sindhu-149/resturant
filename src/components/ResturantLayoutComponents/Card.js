      ...
      <div  className='cardsList'>
          {data?.map(card => {
              ...
              <div className='card'> 
                  ...
                  <img src= {card?.Vegan === 'TRUE' ? "https://img.icons8.com/color/512/vegetarian-food-symbol.png" : (card?.Vegan === 'FALSE' ? "https://img.icons8.com/color/512/non-vegetarian-food-symbol.png" :" ")}  className='veg-nonveg'></img>
